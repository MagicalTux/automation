...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y libcurl4-openssl-dev libicu-dev build-essential uuid-dev libbz2-dev libc-client2007e-dev libexif-dev libgmp-dev libgraphicsmagick1-dev libgraphviz-dev libmemcached-dev libssh2-1-dev libmcrypt-dev libtidy-dev libxslt-dev libkrb5-dev libyaml-dev libzip-dev libhttp-parser-dev autoconf autoconf2.13 poppler-utils libargon2-dev libdjvulibre-dev libfreetype6-dev libjpeg-dev liblcms2-dev liblqr-1-0-dev libltdl-dev libopenexr-dev libpng-dev librsvg2-dev libtiff-dev libwmf-dev libxml2-dev zlib1g-dev libde265-dev libheif-dev libraw-dev liblqr-1-0-dev libdjvulibre-dev libopenexr-dev libpq-dev xfonts-base xfonts-75dpi fonts-takao xvfb memcached nginx postfix ntp git subversion cmake sox libsox-fmt-base libsox-fmt-mp3 faad modplug-tools poppler-utils dcraw ffmpeg libsqlite3-dev libonig-dev libsodium-dev && apt-get clean
