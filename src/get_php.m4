...
if [ x"$PHP_PECL" = x ]; then
	...
	PHP_PECL="imagick uuid libsodium mailparse git://github.com/MagicalTux/php-git2.git proctitle git://github.com/preillyme/v8js.git"
fi
# PECL DEPENCIES
